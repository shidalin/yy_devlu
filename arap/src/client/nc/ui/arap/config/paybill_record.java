...
private List getManagedList0(){  List list = new ArrayList();  list.add(getQueryParam_6927d3());  list.add(getQueryParam_1b5a051());  return list;}

private nc.ui.uif2.userdefitem.QueryParam getQueryParam_6927d3(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#6927d3")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#6927d3");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#6927d3",bean);
...
private nc.ui.uif2.userdefitem.QueryParam getQueryParam_1b5a051(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#1b5a051")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#1b5a051");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#1b5a051",bean);
...
public nc.ui.arap.view.ArapBillCardForm getBillFormEditor(){
 ...
 return (nc.ui.arap.view.ArapBillCardForm)context.get("billFormEditor");
  ...
  bean.setBlankChildrenFilter(getSingleFieldBlankChildrenFilter_92d1());
  bean.setDefValueItf(getBillDefVauleItf());
  bean.setBodyLineActions(getManagedList2());
  bean.setActions(getManagedList5());
  bean.setUserdefitemPreparator(getUserdefitemContainerPreparator_15d3c9f());
  bean.initRealUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter getSingleFieldBlankChildrenFilter_92d1(){
 if(context.get("nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter#92d1")!=null)
 return (nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter)context.get("nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter#92d1");
  ...
  context.put("nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter#92d1",bean);
...
private List getManagedList2(){  List list = new ArrayList();  list.add(getAddLineAction());  list.add(getInsertLineAction_1a70fc2());  list.add(getBodyDelLineAction_fbbeb8());  list.add(getBodyCopyLineAction_1a626a3());  list.add(getBodyPasteLineAction_132bc14());  list.add(getBodyPasteToTailAction_1d9fd0e());  list.add(getActionsBarSeparator());  list.add(getBodyLineEditAction_74b171());  list.add(getActionsBarSeparator());  list.add(getBillBodyZoomAction_12d9c01());  return list;}

private nc.ui.arap.actions.InsertLineAction getInsertLineAction_1a70fc2(){
 if(context.get("nc.ui.arap.actions.InsertLineAction#1a70fc2")!=null)
 return (nc.ui.arap.actions.InsertLineAction)context.get("nc.ui.arap.actions.InsertLineAction#1a70fc2");
  nc.ui.arap.actions.InsertLineAction bean = new nc.ui.arap.actions.InsertLineAction();
  context.put("nc.ui.arap.actions.InsertLineAction#1a70fc2",bean);
...
private nc.ui.arap.actions.BodyDelLineAction getBodyDelLineAction_fbbeb8(){
 if(context.get("nc.ui.arap.actions.BodyDelLineAction#fbbeb8")!=null)
 return (nc.ui.arap.actions.BodyDelLineAction)context.get("nc.ui.arap.actions.BodyDelLineAction#fbbeb8");
  nc.ui.arap.actions.BodyDelLineAction bean = new nc.ui.arap.actions.BodyDelLineAction();
  context.put("nc.ui.arap.actions.BodyDelLineAction#fbbeb8",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.arap.actions.BodyCopyLineAction getBodyCopyLineAction_1a626a3(){
 if(context.get("nc.ui.arap.actions.BodyCopyLineAction#1a626a3")!=null)
 return (nc.ui.arap.actions.BodyCopyLineAction)context.get("nc.ui.arap.actions.BodyCopyLineAction#1a626a3");
  nc.ui.arap.actions.BodyCopyLineAction bean = new nc.ui.arap.actions.BodyCopyLineAction();
  context.put("nc.ui.arap.actions.BodyCopyLineAction#1a626a3",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.arap.actions.BodyPasteLineAction getBodyPasteLineAction_132bc14(){
 if(context.get("nc.ui.arap.actions.BodyPasteLineAction#132bc14")!=null)
 return (nc.ui.arap.actions.BodyPasteLineAction)context.get("nc.ui.arap.actions.BodyPasteLineAction#132bc14");
  nc.ui.arap.actions.BodyPasteLineAction bean = new nc.ui.arap.actions.BodyPasteLineAction();
  context.put("nc.ui.arap.actions.BodyPasteLineAction#132bc14",bean);
...
private nc.ui.arap.actions.BodyPasteToTailAction getBodyPasteToTailAction_1d9fd0e(){
 if(context.get("nc.ui.arap.actions.BodyPasteToTailAction#1d9fd0e")!=null)
 return (nc.ui.arap.actions.BodyPasteToTailAction)context.get("nc.ui.arap.actions.BodyPasteToTailAction#1d9fd0e");
  nc.ui.arap.actions.BodyPasteToTailAction bean = new nc.ui.arap.actions.BodyPasteToTailAction();
  context.put("nc.ui.arap.actions.BodyPasteToTailAction#1d9fd0e",bean);
...
private nc.ui.arap.actions.BodyLineEditAction getBodyLineEditAction_74b171(){
 if(context.get("nc.ui.arap.actions.BodyLineEditAction#74b171")!=null)
 return (nc.ui.arap.actions.BodyLineEditAction)context.get("nc.ui.arap.actions.BodyLineEditAction#74b171");
  nc.ui.arap.actions.BodyLineEditAction bean = new nc.ui.arap.actions.BodyLineEditAction();
  context.put("nc.ui.arap.actions.BodyLineEditAction#74b171",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.arap.actions.BillBodyZoomAction getBillBodyZoomAction_12d9c01(){
 if(context.get("nc.ui.arap.actions.BillBodyZoomAction#12d9c01")!=null)
 return (nc.ui.arap.actions.BillBodyZoomAction)context.get("nc.ui.arap.actions.BillBodyZoomAction#12d9c01");
  nc.ui.arap.actions.BillBodyZoomAction bean = new nc.ui.arap.actions.BillBodyZoomAction();
  context.put("nc.ui.arap.actions.BillBodyZoomAction#12d9c01",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
private nc.ui.uif2.editor.UserdefitemContainerPreparator getUserdefitemContainerPreparator_15d3c9f(){
 if(context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#15d3c9f")!=null)
 return (nc.ui.uif2.editor.UserdefitemContainerPreparator)context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#15d3c9f");
  nc.ui.uif2.editor.UserdefitemContainerPreparator bean = new nc.ui.uif2.editor.UserdefitemContainerPreparator();
  context.put("nc.ui.uif2.editor.UserdefitemContainerPreparator#15d3c9f",bean);
  bean.setContainer(getUserdefitemContainer());
...
private Map getManagedMap0(){  Map map = new HashMap();  map.put(getI18nFB_1643ec6(),getManagedList8());  map.put(getI18nFB_55483d(),getManagedList9());  return map;}

private java.lang.String getI18nFB_1643ec6(){
 if(context.get("nc.ui.uif2.I18nFB#1643ec6")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1643ec6");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1643ec6",bean);  bean.setResDir("uif2");
...
invokeInitializingBean(bean);
 try {
    ...
    context.put("nc.ui.uif2.I18nFB#1643ec6",product);
...
private java.lang.String getI18nFB_55483d(){
 if(context.get("nc.ui.uif2.I18nFB#55483d")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#55483d");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#55483d",bean);  bean.setResDir("uif2");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#55483d",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.arap.actions.ArapAddFlowMenuAciton getAddActionGroup(){
 ...
 return (nc.ui.arap.actions.ArapAddFlowMenuAciton)context.get("addActionGroup");
  ...
  bean.setOrgChangedImpl(getOrgchange());
  bean.setCode("add");
  bean.setName(getI18nFB_1e599ec());
...
private java.lang.String getI18nFB_1e599ec(){
 if(context.get("nc.ui.uif2.I18nFB#1e599ec")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1e599ec");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1e599ec",bean);  bean.setResDir("pubapp_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1e599ec",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.uif2.TangramContainer getContainer(){
 ...
 return (nc.ui.uif2.TangramContainer)context.get("container");
  ...
  bean.setTangramLayoutRoot(getTBNode_191c982());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_191c982(){
 if(context.get("nc.ui.uif2.tangramlayout.node.TBNode#191c982")!=null)
 return (nc.ui.uif2.tangramlayout.node.TBNode)context.get("nc.ui.uif2.tangramlayout.node.TBNode#191c982");
  nc.ui.uif2.tangramlayout.node.TBNode bean = new nc.ui.uif2.tangramlayout.node.TBNode();
  context.put("nc.ui.uif2.tangramlayout.node.TBNode#191c982",bean);
...
private List getManagedList13(){  List list = new ArrayList();  list.add(getCNode_5433ba());  list.add(getHSNode_169e114());  list.add(getHSNode_c0db9a());  list.add(getCNode_15a2671());  return list;}

private nc.ui.uif2.tangramlayout.node.CNode getCNode_5433ba(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#5433ba")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#5433ba");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#5433ba",bean);
  bean.setName(getI18nFB_10cc8d1());
...
private java.lang.String getI18nFB_10cc8d1(){
 if(context.get("nc.ui.uif2.I18nFB#10cc8d1")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#10cc8d1");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#10cc8d1",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#10cc8d1",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private nc.ui.uif2.tangramlayout.node.HSNode getHSNode_169e114(){
 if(context.get("nc.ui.uif2.tangramlayout.node.HSNode#169e114")!=null)
 return (nc.ui.uif2.tangramlayout.node.HSNode)context.get("nc.ui.uif2.tangramlayout.node.HSNode#169e114");
  nc.ui.uif2.tangramlayout.node.HSNode bean = new nc.ui.uif2.tangramlayout.node.HSNode();
  context.put("nc.ui.uif2.tangramlayout.node.HSNode#169e114",bean);
  bean.setLeft(getCNode_10381a());
  bean.setRight(getVSNode_934069());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_10381a(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#10381a")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#10381a");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#10381a",bean);
...
private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_934069(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#934069")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#934069");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#934069",bean);
  bean.setUp(getCNode_d37298());
  bean.setDown(getCNode_1c536d6());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_d37298(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#d37298")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#d37298");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#d37298",bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_1c536d6(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1c536d6")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1c536d6");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1c536d6",bean);
  bean.setName(getI18nFB_85fbc());
...
private java.lang.String getI18nFB_85fbc(){
 if(context.get("nc.ui.uif2.I18nFB#85fbc")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#85fbc");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#85fbc",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#85fbc",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private nc.ui.uif2.tangramlayout.node.HSNode getHSNode_c0db9a(){
 if(context.get("nc.ui.uif2.tangramlayout.node.HSNode#c0db9a")!=null)
 return (nc.ui.uif2.tangramlayout.node.HSNode)context.get("nc.ui.uif2.tangramlayout.node.HSNode#c0db9a");
  nc.ui.uif2.tangramlayout.node.HSNode bean = new nc.ui.uif2.tangramlayout.node.HSNode();
  context.put("nc.ui.uif2.tangramlayout.node.HSNode#c0db9a",bean);
  bean.setLeft(getVSNode_1800f19());
  bean.setRight(getCNode_5f54ee());
...
private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_1800f19(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#1800f19")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#1800f19");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#1800f19",bean);
  bean.setUp(getCNode_382966());
  bean.setDown(getCNode_18b7831());
  bean.setShowMode("NoDivider");
  bean.setDividerLocation(30f);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_382966(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#382966")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#382966");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#382966",bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_18b7831(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#18b7831")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#18b7831");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#18b7831",bean);
  bean.setName(getI18nFB_125e7a6());
...
private java.lang.String getI18nFB_125e7a6(){
 if(context.get("nc.ui.uif2.I18nFB#125e7a6")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#125e7a6");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#125e7a6",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#125e7a6",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private nc.ui.uif2.tangramlayout.node.CNode getCNode_5f54ee(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#5f54ee")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#5f54ee");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#5f54ee",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.uif2.tangramlayout.node.CNode getCNode_15a2671(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#15a2671")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#15a2671");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#15a2671",bean);
  bean.setName(getI18nFB_1917fc0());
...
private java.lang.String getI18nFB_1917fc0(){
 if(context.get("nc.ui.uif2.I18nFB#1917fc0")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1917fc0");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1917fc0",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1917fc0",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private List getManagedList14(){  List list = new ArrayList();  list.add(getDocumentManage());  list.add(getActionsBarSeparator());  list.add(getFirstLineAction());  list.add(getPreLineAction());  list.add(getNextLineAction());  list.add(getLastLineAction());  list.add(getActionsBarSeparator());  list.add(getBillHeadZoomAction_1945ea9());  return list;}

private nc.ui.arap.actions.BillHeadZoomAction getBillHeadZoomAction_1945ea9(){
 if(context.get("nc.ui.arap.actions.BillHeadZoomAction#1945ea9")!=null)
 return (nc.ui.arap.actions.BillHeadZoomAction)context.get("nc.ui.arap.actions.BillHeadZoomAction#1945ea9");
  nc.ui.arap.actions.BillHeadZoomAction bean = new nc.ui.arap.actions.BillHeadZoomAction();
  context.put("nc.ui.arap.actions.BillHeadZoomAction#1945ea9",bean);
  bean.setModel(getManageAppModel());
  bean.setBillForm(getBillFormEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
public nc.ui.arap.view.ArapBillCardForm getMakeupEditor(){
 ...
 return (nc.ui.arap.view.ArapBillCardForm)context.get("makeupEditor");
  ...
  bean.setAutoAddLine(false);
  bean.setTemplateNotNullValidate(true);
  bean.setUserdefitemPreparator(getUserdefitemContainerPreparator_1d2df66());
  bean.initRealUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.editor.UserdefitemContainerPreparator getUserdefitemContainerPreparator_1d2df66(){
 if(context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#1d2df66")!=null)
 return (nc.ui.uif2.editor.UserdefitemContainerPreparator)context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#1d2df66");
  nc.ui.uif2.editor.UserdefitemContainerPreparator bean = new nc.ui.uif2.editor.UserdefitemContainerPreparator();
  context.put("nc.ui.uif2.editor.UserdefitemContainerPreparator#1d2df66",bean);
  bean.setContainer(getUserdefitemContainer());
...
public nc.ui.arap.actions.BillListApproveAction getApproveListBatchAction(){
 ...
 return (nc.ui.arap.actions.BillListApproveAction)context.get("ApproveListBatchAction");
  ...
  bean.setIsbatch("Y");
  bean.setInterceptor(getInterceptor());
  bean.setTpaProgressUtil(getTPAProgressUtil_148a79a());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.uif2.components.progress.TPAProgressUtil getTPAProgressUtil_148a79a(){
 if(context.get("nc.ui.uif2.components.progress.TPAProgressUtil#148a79a")!=null)
 return (nc.ui.uif2.components.progress.TPAProgressUtil)context.get("nc.ui.uif2.components.progress.TPAProgressUtil#148a79a");
  nc.ui.uif2.components.progress.TPAProgressUtil bean = new nc.ui.uif2.components.progress.TPAProgressUtil();
  context.put("nc.ui.uif2.components.progress.TPAProgressUtil#148a79a",bean);
  bean.setContext(getContext());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
public nc.ui.arap.actions.BillListApproveAction getApproveListAction(){
 ...
 return (nc.ui.arap.actions.BillListApproveAction)context.get("ApproveListAction");
  ...
  bean.setIsbatch("N");
  bean.setInterceptor(getInterceptor());
  bean.setTpaProgressUtil(getTPAProgressUtil_f390f2());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.uif2.components.progress.TPAProgressUtil getTPAProgressUtil_f390f2(){
 if(context.get("nc.ui.uif2.components.progress.TPAProgressUtil#f390f2")!=null)
 return (nc.ui.uif2.components.progress.TPAProgressUtil)context.get("nc.ui.uif2.components.progress.TPAProgressUtil#f390f2");
  nc.ui.uif2.components.progress.TPAProgressUtil bean = new nc.ui.uif2.components.progress.TPAProgressUtil();
  context.put("nc.ui.uif2.components.progress.TPAProgressUtil#f390f2",bean);
  bean.setContext(getContext());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private java.lang.String getI18nFB_fb0f10(){
 if(context.get("nc.ui.uif2.I18nFB#fb0f10")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#fb0f10");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#fb0f10",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#fb0f10",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList19(){  List list = new ArrayList();  list.add(getDeleteAction());  list.add(getEditAction());  list.add(getTempSaveAction());  list.add(getWriteBack());  list.add(getDocumentManage());  list.add(getPrepayAction());  return list;}
...
public nc.funcnode.ui.action.MenuAction getBillOperateActionGroup_Record(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("billOperateActionGroup_Record");
  ...
  bean.setCode("billOperate");
  bean.setName(getI18nFB_199fa27());
...
private java.lang.String getI18nFB_199fa27(){
 if(context.get("nc.ui.uif2.I18nFB#199fa27")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#199fa27");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#199fa27",bean);  bean.setResDir("common");
  bean.setResId("arapcommonv6-0137");
  bean.setDefaultValue("单据操作");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#199fa27",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.MenuAction getBillOperateActionGroup_Init(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("billOperateActionGroup_Init");
  ...
  bean.setCode("billOperate");
  bean.setName(getI18nFB_1f626a6());
...
private java.lang.String getI18nFB_1f626a6(){
 if(context.get("nc.ui.uif2.I18nFB#1f626a6")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1f626a6");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1f626a6",bean);  bean.setResDir("common");
  bean.setResId("arapcommonv6-0137");
  bean.setDefaultValue("单据操作");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1f626a6",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.MenuAction getBillOperateActionGroup_List(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("billOperateActionGroup_List");
  ...
  bean.setName(getI18nFB_16377f7());
...
private java.lang.String getI18nFB_16377f7(){
 if(context.get("nc.ui.uif2.I18nFB#16377f7")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#16377f7");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#16377f7",bean);  bean.setResDir("common");
  bean.setResId("arapcommonv6-0137");
  bean.setDefaultValue("单据操作");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#16377f7",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_4ffbf2(){
 if(context.get("nc.ui.uif2.I18nFB#4ffbf2")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#4ffbf2");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#4ffbf2",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#4ffbf2",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_e891b5(){
 if(context.get("nc.ui.uif2.I18nFB#e891b5")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#e891b5");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#e891b5",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#e891b5",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_b61f43(){
 if(context.get("nc.ui.uif2.I18nFB#b61f43")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#b61f43");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#b61f43",bean);  bean.setResDir("common");
  bean.setResId("arapcommonv6-0142");
  bean.setDefaultValue("审批");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#b61f43",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_be7ea3(){
 if(context.get("nc.ui.uif2.I18nFB#be7ea3")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#be7ea3");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#be7ea3",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#be7ea3",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_6c350e(){
 if(context.get("nc.ui.uif2.I18nFB#6c350e")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#6c350e");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#6c350e",bean);  bean.setResDir("2006pub_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#6c350e",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_43b624(){
 if(context.get("nc.ui.uif2.I18nFB#43b624")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#43b624");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#43b624",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#43b624",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.GroupAction getPrintOperateActionGroup_List(){
 ...
 return (nc.funcnode.ui.action.GroupAction)context.get("printOperateActionGroup_List");
  ...
  bean.setName(getI18nFB_115bdcc());
...
private java.lang.String getI18nFB_115bdcc(){
 if(context.get("nc.ui.uif2.I18nFB#115bdcc")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#115bdcc");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#115bdcc",bean);  bean.setResDir("common");
  bean.setResId("arapcommonv6-0139");
  bean.setDefaultValue("打印");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#115bdcc",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_9013ef(){
 if(context.get("nc.ui.uif2.I18nFB#9013ef")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#9013ef");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#9013ef",bean);  bean.setResDir("pubapp_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#9013ef",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList30(){  List list = new ArrayList();  list.add(getLinkQueryAction());  list.add(getLinkSettleInfoAction());  list.add(getLinkInformerAction());  list.add(getFlowStateQueryAction());  list.add(getBalanceLinkQueryAction());  list.add(getDealLinkQueryAction());  list.add(getLinkVoucharQueryAction());  list.add(getBconferQueryAction());  list.add(getTbbLinkAction());  return list;}
...
private java.lang.String getI18nFB_99f45a(){
 if(context.get("nc.ui.uif2.I18nFB#99f45a")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#99f45a");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#99f45a",bean);  bean.setResDir("2006pub_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#99f45a",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.MenuAction getBillAssistantActionGroup_List(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("billAssistantActionGroup_List");
  ...
  bean.setCode("billAssistant");
  bean.setName(getI18nFB_17962df());
...
private java.lang.String getI18nFB_17962df(){
 if(context.get("nc.ui.uif2.I18nFB#17962df")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#17962df");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#17962df",bean);  bean.setResDir("2006pub_0");
  bean.setResId("02006pub-0643");
  bean.setDefaultValue("辅助功能");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#17962df",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList44(){  List list = new ArrayList();  list.add(getDocumentManage());  list.add(getAssociateSettInfoAction());  return list;}
...
private java.lang.String getI18nFB_4a2355(){
 if(context.get("nc.ui.uif2.I18nFB#4a2355")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#4a2355");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#4a2355",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#4a2355",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList45(){  List list = new ArrayList();  list.add(getBillCommisionPaySaveAction());  list.add(getBillCancelCommisionPayAction());  return list;}
...
public nc.ui.arap.importable.PayRecordImportablePanel getImportableEditor(){
 ...
 return (nc.ui.arap.importable.PayRecordImportablePanel)context.get("importableEditor");
...
private java.lang.String getI18nFB_e44584(){
 if(context.get("nc.ui.uif2.I18nFB#e44584")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#e44584");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#e44584",bean);  bean.setResDir("2006pub_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#e44584",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private List getManagedList47(){  List list = new ArrayList();  list.add(getAddActionGroup());  list.add(getAddFksqAction());  list.add(getEditAction());  list.add(getDeleteAction());  list.add(getCopyAction());  list.add(getCurrNullAction());  list.add(getQueryAction());  list.add(getRefreshAllAction());  list.add(getCurrNullAction());  list.add(getTranstype());  list.add(getBillAssistantActionGroup_List());  list.add(getCurrNullAction());  list.add(getRelatedQueryActionGroup());  list.add(getCurrNullAction());  list.add(getImportexportActionGroup());  list.add(getPrintOperateActionGroup_List());  return list;}
...
private List getManagedList48(){  List list = new ArrayList();  list.add(getAddActionGroup());  list.add(getAddFksqAction());  list.add(getEditAction());  list.add(getDeleteAction());  list.add(getCopyAction());  list.add(getCurrNullAction());  list.add(getQueryAction());  list.add(getRefreshSingAction());  list.add(getCurrNullAction());  list.add(getTranstype());  list.add(getBillAssistantActionGroup());  list.add(getCurrNullAction());  list.add(getRelatedQueryActionGroup());  list.add(getCurrNullAction());  list.add(getImportexportActionGroup());  list.add(getPrintOperateActionGroup());  return list;}

private List getManagedList49(){  List list = new ArrayList();  list.add(getSaveAction());  list.add(getTempSaveAction());  list.add(getCurrNullAction());  list.add(getCancelAction());  list.add(getCurrNullAction());  list.add(getDocumentManage());  return list;}

public nc.ui.ap.ap_paybill.billref.AddFksqAction getAddFksqAction(){
 if(context.get("addFksqAction")!=null)
 return (nc.ui.ap.ap_paybill.billref.AddFksqAction)context.get("addFksqAction");
  nc.ui.ap.ap_paybill.billref.AddFksqAction bean = new nc.ui.ap.ap_paybill.billref.AddFksqAction();
  context.put("addFksqAction",bean);
  bean.setSourceBillType("FKSQ");
  bean.setSourceBillName("参照付款申请");
  bean.setFlowBillType(false);
  bean.setModel(getManageAppModel());
  bean.setEditor(getBillFormEditor());
  bean.setTransferViewProcessor(getTransferProcessorforPaybill());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

public nc.ui.pubapp.billref.dest.TransferViewProcessor getTransferProcessorforPaybill(){
 if(context.get("transferProcessorforPaybill")!=null)
 return (nc.ui.pubapp.billref.dest.TransferViewProcessor)context.get("transferProcessorforPaybill");
  nc.ui.pubapp.billref.dest.TransferViewProcessor bean = new nc.ui.pubapp.billref.dest.TransferViewProcessor();
  context.put("transferProcessorforPaybill",bean);
  bean.setList(getListView());
  bean.setActionContainer(getListActions());
  bean.setCardActionContainer(getCardActions());
  bean.setTransferLogic(getTransferLogicforPaybill());
  bean.setBillForm(getBillFormEditor());
  bean.setCancelAction(getCancelAction());
  bean.setSaveAction(getSaveAction());
setBeanFacotryIfBeanFacatoryAware(bean);
...
public nc.ui.ap.ap_paybill.billref.FksqRefPaybillTransferBillDataLogic getTransferLogicforPaybill(){
 if(context.get("transferLogicforPaybill")!=null)
 return (nc.ui.ap.ap_paybill.billref.FksqRefPaybillTransferBillDataLogic)context.get("transferLogicforPaybill");
  nc.ui.ap.ap_paybill.billref.FksqRefPaybillTransferBillDataLogic bean = new nc.ui.ap.ap_paybill.billref.FksqRefPaybillTransferBillDataLogic();
  context.put("transferLogicforPaybill",bean);
  bean.setBillForm(getBillFormEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
